...
[
 ...
 },
 {
  ...
  "answer": "ウ",
  "hasImage": false,
  "text": "関係R(A，B，C，D，E，F)において，次の関数従属が成立するとき，候補キーとなるのはどれか。 〔関数従属〕 A→B，A→F，B→C，C→D，{B，C}→E，{C，F}→A",
  "choices": {
   "ア": "B",
   "イ": "{B，C}",
   "ウ": "{B，F}",
 ...
 },
 {
  ...
  "answer": "エ",
  "hasImage": false,
  "text": "手順に示す処理を行ったとき，検証できることはどれか。 〔手順〕送信者Aはファイルのハッシュ値を計算して，信頼できる第三者機関に送信する。第三者機関は，信頼できる日時を保持しており，受信したハッシュ値とその受信日時を結合し(結合データ)，そのデジタル署名を生成し，デジタル署名と結合データの組(デジタル署名済みの結合データ)を送信者Aに返信する。送信者Aはファイルと第三者機関から送られてきたデジタル署名済みの結合データを受信者Bに送信する。受信者Bは第三者機関のデジタル署名を確認し，ファイルから計算したハッシュ値と，デジタル署名済みの結合データから取り出されたハッシュ値を照合する。そして，結合データから取り出された日時を確認する。",
  "choices": {
 ...
 },
 {
  ...
  "answer": "エ",
  "hasImage": false,
  "text": "二つの独立したテストグループA，Bが，あるシステムについて一定期間並行してテストを行い，それぞれN_A個及びN_B個のエラーを検出した。このうち，共通のエラーはN_AB個であった。このシステムの総エラー数Nを予測する式はどれか。ここで，N_A＞0，N_B＞0，N_AB＞0とし，グループA，Bのエラーを検出する能力及び効率は等しいものとする。",
  "choices": {
   "ア": "N＝N_A＋N_B－N_AB",
   "イ": "N＝N_AB×N_A×N_B",
   "ウ": "N＝(N_A＋N_B)／N_AB",
 ...
 },
 {
  ...
  "answer": "イ",
  "hasImage": false,
  "text": "ITILは，各プロセスに対する重要成功要因(CSF)と重要業績評価指標(KPI)を例示している。次のインシデント管理のCSFに対するKPIとして，適切なものはどれか。 〔CSF〕 インシデントをできるだけ迅速に解決し，事業へのインパクトを最小限にする。",
  "choices": {
   "ア": "インシデントの総件数",

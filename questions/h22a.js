...
[
 {
  ...
  "answer": "イ",
  "hasImage": false,
  "text": "後置換記法（逆ポーランド表記法）では，例えば，式 Y＝(A－B)×C を YAB－C×＝ と表現する。 次の式を後置換記法で表現したものはどれか。 Y＝(A＋B)×(C－(D÷E))",
  "choices": {
   "ア": "YAB＋C－DE÷×＝",
   "イ": "YAB＋CDE÷－×＝",
   "ウ": "YAB＋EDC÷－×＝",
 ...
 },
 {
  ...
  "answer": "ウ",
  "hasImage": false,
  "text": "次の表定義において，\"在庫\" 表の製品番号に定義された参照制約によって拒否される可能性のある操作はどれか。ここで，実線は主キーを，破線は外部キーを表す。 在庫（在庫管理番号, 製品番号, 在庫量） 製品（製品番号, 製品名, 型, 単価）",
  "choices": {
   "ア": "\"在庫\"表の行削除",
   "イ": "\"在庫\"表の表削除",
   "ウ": "\"在庫\"表への行追加",
 ...
 },
 {
  ...
  "answer": "エ",
  "hasImage": false,
  "text": "工程別の生産性が次のとき，全体の生産性を表す式はどれか。 設計工程：Xステップ／人月 製造工程：Yステップ／人月 試験工程：Zステップ／人月",
  "choices": {
   "ア": "X＋Y＋Z",
   "イ": "X＋Y＋Z",
   "ウ": "1",
 ...
 },
 {
  ...
  "answer": "ウ",
  "hasImage": false,
  "text": "次の処理条件でサーバ上のファイルを磁気テープにバックアップするとき，バックアップの運用に必要な磁気テープは何本か。 〔処理条件〕毎月初日(1日)にフルバックアップを取る。フルバックアップは1回につき1本の磁気テープを必要とする。フルバックアップを取った翌日から次のフルバックアップまでは，毎日，差分バックアップを取る。差分バックアップは，差分バックアップ用として別の磁気テープに追記し，1カ月分が1本に記録できる。常に6か月前の同一日までのデータについて，指定日の状態にファイルを復元できることを保証する。ただし，6か月前の同一日が存在しない場合は，当該月の月末以降のデータについて，指定日の状態にファイルを復元できることを保証する (例：10月31日の場合は，4月30日以降のデータについて，指定日の状態にファイルを復元できることを保証する)。",
  "choices": {
   "ア": "12",
   "イ": "13",
   "ウ": "14",

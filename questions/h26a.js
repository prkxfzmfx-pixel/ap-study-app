 ...
 */
window.AP_REGISTER(
{"key": "h26a", "year": 26, "term": "aki", "label": "平成26年秋", "total": 80, "included": 76, "hasExpl": false},
[
 {
  "id": "h26a-q1",
  "year": 26,
 ...
 },
 {
  ...
  "answer": "イ",
  "hasImage": false,
  "text": "コンピュータによる伝票処理システムがある。このシステムは，伝票データをためる待ち行列をもち，M/M/1の待ち行列モデルが適用できるものとする。平均待ち時間がT秒以上となるのは，処理装置の利用率が少なくとも何%以上となったときか。ここで，伝票データをためる待ち行列の特徴は次のとおりである。伝票データは，ポアソン分布に従って発生する。伝票データのたまる数に制限はない。1件の伝票データの処理時間は，平均T秒の指数分布に従う。",
  "choices": {
   "ア": "33",
   "イ": "50",
   "ウ": "67",
 ...
 },
 {
  ...
  "answer": "イ",
  "hasImage": true,
  "text": "グラフに示される頂点V_1からV_4，V_5，V_6の各点への最短所要時間を求め，短い順に並べたものはどれか。ここで，グラフ中の数値は各区間の所要時間を表すものとし，最短所要時間が同ーの場合には添字の小さい順に並べるものとする。",
  "choices": {
   "ア": "V_4，V_5，V_6",
   "イ": "V_4，V_6，V_5",
   "ウ": "V_5，V_4，V_6",
 ...
 },
 {
  ...
  "answer": "ウ",
  "hasImage": false,
  "text": "次の条件で運転するクライアントサーバシステムにおいて，ネットワークに必要な転送速度は，最低何ビット／秒か。 〔条件〕トランザクション1件の平均的な処理は，CPU命令300万ステップとデータ入出力40回で構成され，ネットワークで転送されるデータは送受信それぞれ1,000バイトである。サーバでのCPU命令1ステップの平均実行時間は300ナノ秒である。データ入出力は1回平均20ミリ秒で処理されている。1バイトは8ビットとする。クライアントにおけるデータの送信開始から受信完了までに許容される時間は2.5秒である。サーバは1CPU，1コアで構成されている。待ち時間及び，その他のオーバーヘッドは考慮しない。",
  "choices": {
   "ア": "10,000",
   "イ": "16,000",
   "ウ": "20,000",
 ...
 },
 {
  ...
  "answer": "エ",
  "hasImage": true,
  "text": "最大利益が見込める新製品の設定価格はどれか。ここで，いずれの場合にも，次の費用が発生するものとする。 固定費：1,000,000円 変動費：600円／個",
  "choices": {
   "ア": "1,000",
   "イ": "1,200",
   "ウ": "1,400",

...
[
 {
  ...
  "answer": "ア",
  "hasImage": false,
  "text": "nビットの値 L_1，L_2がある。次の操作によって得られる値L_3は，L_1とL_2に対するどの論理演算の結果と同じか。 〔操作〕L_1とL_2のビットごとの論理和をとって，変数Xに記憶する。L_1とL_2のビットごとの論理積をとって更に否定をとり，変数Yに記憶する。XとYのビットごとの論理積をとって，結果をL_3とする。",
  "choices": {
   "ア": "排他的論理和",
   "イ": "排他的論理和の否定",
   "ウ": "論理積の否定",
 ...
 },
 {
  ...
  "answer": "ウ",
  "hasImage": false,
  "text": "次の表において，\"在庫\" 表の製品番号に定義された参照制約によって拒否される可能性のある操作はどれか。ここで，実線の下線は主キーを，破線の下線は外部キーを表す。 在庫（在庫管理番号, 製品番号, 在庫量） 製品（製品番号, 製品名, 型, 単価）",
  "choices": {
   "ア": "\"在庫\"表の行削除",
   "イ": "\"在庫\"表の表削除",
   "ウ": "\"在庫\"表への行追加",

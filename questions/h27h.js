...
[
 ...
 },
 {
  ...
  "answer": "ウ",
  "hasImage": false,
  "text": "\"部品\"表のメーカーコード列に対し，B^+木インデックスを作成した。これによって，検索の性能改善が最も期待できる操作はどれか。ここで，部品及びメーカーのデータ件数は十分に多く，メーカーコードの値は均一に分散されているものとする。また，ごく少数の行には，メーカーコード列にNULLが設定されている。ここで，実線の下線は主キーを，破線の下線は外部キーを表す。\n部品(部品コード，部品名，メーカーコード)\nメーカー(メーカーコード，メーカー名，住所)",
  "choices": {

...
[
 ...
 },
 {
  ...
  "answer": "エ",
  "hasImage": false,
  "text": "4ビットから成る情報ビット x_1x_2x_3x_4 に対して， (x_1＋x_2＋x_3＋x_5) mod 2＝0 (x_1＋x_2＋x_4＋x_6) mod 2＝0 (x_2＋x_3＋x_4＋x_7) mod 2＝0 を満たす冗長ビット x_5x_6x_7 を付加した符号 x_1x_2x_3x_4x_5x_6x_7 を送信する。 受信符号 y_1y_2y_3y_4y_5y_6y_7 が，送信符号と高々1ビットしか異ならないとき， (y_1＋y_2＋y_3＋y_5) mod 2 (y_1＋y_2＋y_4＋y_6) mod 2 (y_2＋y_3＋y_4＋y_7) mod 2 がそれぞれ0になるかどうかによって，正しい情報ビット x_1x_2x_3x_4 を求めることが可能である。y_1y_2y_3y_4y_5y_6y_7＝1100010 であるとき，正しい情報ビットはどれか。ここで，a mod b は，aをbで割った余りを表す。",
  "choices": {
   "ア": "0100",
   "イ": "1000",
   "ウ": "1100",
 ...
 },
 {
  ...
  "answer": "イ",
  "hasImage": false,
  "text": "次の関数g(x)の定義に従ってg(4)を再帰的に求めるとき，必要な加算の回数は幾らか。 g(x) = if x<2 then 1 else g(x－1)＋g(x－2)",
  "choices": {
   "ア": "3",
   "イ": "4",
   "ウ": "5",
 ...
 },
 {
  ...
  "answer": "エ",
  "hasImage": false,
  "text": "三つの媒体A～Cに次の条件でファイル領域を割り当てた場合，割り当てた領域の総量が大きい順に媒体を並べたものはどれか。 〔条件〕ファイル領域を割り当てる際の媒体選択アルゴリズムとして，空き領域が最大の媒体を選択する方式を採用する。割当て要求されるファイル領域の大きさは，順に90，30，40，40，70，30(Mバイト)であり，割り当てられたファイル領域は，途中で解放されない。各媒体は容量が同一であり，割当て要求に対して十分な大きさをもち，初めは全て空きの状態である。空き領域の大きさが等しい場合には，A，B，Cの順に選択する。",
  "choices": {
   "ア": "A，B，C",
   "イ": "A，C，B",
   "ウ": "B，A，C",
 ...
 },
 {
  ...
  "answer": "ア",
  "hasImage": false,
  "text": "手順に示すハッシュ関数とメッセージダイジェストの処理を行うことで得られるセキュリティ上の効果はどれか。ここで，メッセージダイジェストは安全な方法で保護され，改ざんや破壊がされていないものとする。 〔手順〕送信者Aは，電子メールの本文からハッシュ関数を用いて，メッセージダイジェストを作成する。電子メールの本文とメッセージダイジェストを別々に受信者Bに送信する。受信者Bは受信した電子メールの本文からハッシュ関数を用いて，メッセージダイジェストを作成する。その作成したメッセージダイジェストと，受信したメッセージダイジェストを比較する。",
  "choices": {
   "ア": "電子メールの改ざんの有無の確認",
   "イ": "電子メールの誤送信の防止",
   "ウ": "電子メールの送達確認",

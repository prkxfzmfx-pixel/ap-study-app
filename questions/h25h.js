...
[
 ...
 },
 {
  ...
  "answer": "イ",
  "hasImage": false,
  "text": "ページング方式の仮想記憶において，ページフォールト発生時のオーバーヘッドによる1命令当たりの平均遅れ時間を求める式はどれか。 〔記号の説明〕 t:1回当たりのページフォールト処理時間f:ページフォールト発生率m:1命令当たりの平均主記憶アクセス回数",
  "choices": {
   "ア": "t－f×m",
   "イ": "t×f×m",
   "ウ": "t×f÷m",
 ...
 },
 {
  ...
  "answer": "イ",
  "hasImage": true,
  "text": "ある会社の生産計画部では，毎月25日に次の手続きで翌月の計画生産量を決定している。8月分の計画生産量を求める式はどれか。 〔手続〕当月末の予想在庫量を，前月末の実在庫量と当月の計画生産量と予想販売量から求める。当月末の予想在庫と，翌月分の予想販売量から，翌月末の予想在庫量が翌々月から3か月間の予想販売量と等しくなるように翌月の計画生産量を決定する。",
  "choices": {
   "ア": "I6＋P7－S7＋S8",
   "イ": "S8＋S9＋S10＋S11－I7",
   "ウ": "S8＋S9＋S10＋S11－I8",

...
[
 ...
 },
 {
  ...
  "answer": "エ",
  "hasImage": false,
  "text": "負の整数を表現する代表的な方法として，次の3種類がある。 1の補数による表現2の補数による表現絶対値に符号を付けた表現(左端ビットが0の場合は正，1の場合は負) 4ビットのパターン1101を a～c の方法で表現したものと解釈したとき，値が小さい順になるように三つの方法を並べたものはどれか。",
  "choices": {
   "ア": "a，c，b",
   "イ": "b，a，c",
   "ウ": "b，c，a",
 ...
 },
 {
  ...
  "answer": "イ",
  "hasImage": false,
  "text": "通信回線を使用したデータ伝送システムにM/M/1の待ち行列モデルを適用すると，平均回線待ち時間，平均伝送時間，回線利用率の関係は，次の式で表すことができる。平均回線待ち時間＝平均伝送時間×回線利用率1－回線利用率回線利用率が0%から徐々に上がっていく場合，平均回線待ち時間が平均伝送時間よりも最初に長くなるのは，回線利用率が何%を超えたときか。",
  "choices": {
   "ア": "40",
   "イ": "50",
   "ウ": "60",
 ...
 },
 {
  ...
  "answer": "イ",
  "hasImage": false,
  "text": "再帰的に定義された手続きprocで，proc(5)を実行したとき，印字される数字を順番に並べたものはどれか。 proc(n) n＝0 ならば戻る そうでなければ { nを印字する proc(n－1)を呼び出す nを印字する } を実行して戻る",
  "choices": {
   "ア": "543212345",
   "イ": "5432112345",
   "ウ": "54321012345",
 ...
 },
 {
  ...
  "answer": "エ",
  "hasImage": true,
  "text": "表は，現行プロジェクトのソフトウェアの誤りの発生・除去の実績，及び次期プロジェクトにおける誤り除去の目標を記述したものである。誤りは，設計とコーディングの作業で埋め込まれ，デザインレビュー，コードレビュー及びテストですべて除去されるものとする。次期プロジェクトにおいても，ソフトウェアの規模と誤りの発生状況は変わらないと仮定したときに，テストで除去すべきソフトウェア誤りの比率は全体の何%となるか。 〔ソフトウェア誤りが埋め込まれる工程ごとの割合〕 〔ソフトウェア誤りがレビューごとに除去される割合〕",
  "choices": {
   "ア": "17.5",
   "イ": "25",
   "ウ": "30",
 ...
 },
 {
  ...
  "answer": "ウ",
  "hasImage": true,
  "text": "リーダーシップのスタイルは，その組織の状況に合わせる必要がある。組織とリーダーシップの関係に次のことが想定できるとすると，野球チームの監督のリーダーシップのスタイルとして，図のdと考えられるものはどれか。 〔組織とリーダーシップの関係〕 組織は発足当時，構成員や仕組みの成熟度が低いので，リーダーが仕事本位のリーダーシップで引っ張っていく。成熟度が上がるにつれ，リーダーと構成員の人間関係が培われ，仕事本位から人間関係本位のリーダーシップに移行していく。更に成熟度が進むと，構成員は自主的に行動でき，リーダーシップは仕事本位，人間関係本位のいずれもが弱まっていく。",
  "choices": {

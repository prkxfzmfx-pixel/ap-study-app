...
[
 ...
 },
 {
  ...
  "answer": "ア",
  "hasImage": false,
  "text": "0≦x≦1の範囲で単調に増加する連続関数ƒ(x)が ƒ(0)＜0≦ƒ(1) を満たすときに，区間内で ƒ(x)＝0 であるxの値を近似的に求めるアルゴリズムにおいて，(2)は何回実行されるか。 〔アルゴリズム〕x_0←0，x_1←1とする。x←x_0＋x_12とする。x_1－x＜0.001ならばxの値を近似値として終了する。ƒ(x)≧0ならばx_1←xとして，そうでなければx_0←xとする。(2)に戻る。",
  "choices": {
   "ア": "10",
   "イ": "20",
   "ウ": "100",
 ...
 },
 {
  ...
  "answer": "エ",
  "hasImage": false,
  "text": "データベース(DB)へのアクセスを行うブラウザからのリクエスト処理を，Webサーバが受信し解読した後に行う一連の実行処理の順序はどれか。ここで，Webサーバはリクエスト処理ごとにDBへの接続と切断を行うものとする。 〔実行処理〕DBの切断DBへのアクセスDBへの接続HTML文書の組立てSQL文の組立てブラウザへの送信",
  "choices": {
   "ア": "③，②，⑤，④，⑥，①",
   "イ": "③，④，②，⑤，⑥，①",
   "ウ": "③，④，⑤，②，⑥，①",
 ...
 },
 {
  ...
  "answer": "エ",
  "hasImage": true,
  "text": "次の条件を満足する論理回路はどれか。 〔条件〕 階段の上下にあるスイッチA又はBで，一つの照明を点灯・消灯する。すなわち，一方のスイッチの状態にかかわらず，他方のスイッチで照明を点灯・消灯できる。",
  "choices": {
   "ア": "AND",
   "イ": "NAND",
   "ウ": "NOR",
 ...
 },
 {
  ...
  "answer": "エ",
  "hasImage": false,
  "text": "JIS X 0160におけるソフトウェア実装プロセスの下位レベルのプロセスのうち，次のタスクを実施するものはどれか。 〔タスク〕ソフトウェア品目の外部インタフェース，及びソフトウェアコンポーネント間のインタフェースについて最上位レベルの設計を行う。データベースについて最上位レベルの設計を行う。ソフトウェア結合のために暫定的なテスト要求事項及びスケジュールを定義する。",
  "choices": {
   "ア": "ソフトウェア結合プロセス",
   "イ": "ソフトウェア構築プロセス",
   "ウ": "ソフトウェア詳細設計プロセス",
 ...
 },
 {
  ...
  "answer": "イ",
  "hasImage": true,
  "text": "過去のプロジェクトの開発実績から構築した作業配分モデルがある。システム要件定義からシステム内部設計までをモデルどおりに228日で完了し，プログラム開発を開始した。現在，200本のプログラムのうち100本のプログラム開発を完了し，残り100本は未着手の状況である。プログラム開発以降もモデルどおりに進捗すると仮定するとき，プロジェクト全体の完了まで，あと何日掛かるか。ここで，各プログラムの開発に掛かる工数及び期間は，全てのプログラムで同一であるものとする。 〔作業配分モデル〕",
  "choices": {
   "ア": "140",
   "イ": "150",
   "ウ": "161",
